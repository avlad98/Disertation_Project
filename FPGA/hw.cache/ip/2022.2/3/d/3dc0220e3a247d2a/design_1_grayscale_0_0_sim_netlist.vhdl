...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_grayscale is
  ...
  attribute SOFT_HLUTNM of \color[7]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \color[8]_INST_0\ : label is "soft_lutpair1";
begin
  color(8 downto 0) <= \^color\(8 downto 0);
...
\color[8]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "grayscale,Vivado 2022.2";
