...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_contrast_adjustment is
  ...
  signal color1 : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal \color1_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_1_n_1\ : STD_LOGIC;
  signal \color1_carry__0_i_1_n_2\ : STD_LOGIC;
  signal \color1_carry__0_i_1_n_3\ : STD_LOGIC;
  signal \color1_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_5_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_6_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_7_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_8_n_0\ : STD_LOGIC;
  signal \color1_carry__0_i_9_n_0\ : STD_LOGIC;
  ...
  signal \color1_carry__1_i_3_n_3\ : STD_LOGIC;
  signal \color1_carry__1_n_2\ : STD_LOGIC;
  signal \color1_carry__1_n_3\ : STD_LOGIC;
  signal color1_carry_i_1_n_0 : STD_LOGIC;
  signal color1_carry_i_1_n_1 : STD_LOGIC;
  signal color1_carry_i_1_n_2 : STD_LOGIC;
  signal color1_carry_i_1_n_3 : STD_LOGIC;
  signal color1_carry_i_2_n_0 : STD_LOGIC;
  signal color1_carry_i_3_n_0 : STD_LOGIC;
  signal color1_carry_i_4_n_0 : STD_LOGIC;
  signal color1_carry_i_5_n_0 : STD_LOGIC;
  signal color1_carry_i_6_n_0 : STD_LOGIC;
  signal color1_carry_i_7_n_0 : STD_LOGIC;
  signal color1_carry_i_8_n_0 : STD_LOGIC;
  ...
  signal \color[0]_INST_0_i_7_n_0\ : STD_LOGIC;
  signal \color[0]_INST_0_i_8_n_0\ : STD_LOGIC;
  ...
  signal \NLW_color1_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_color1_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_color1_carry__1_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_color1_carry__1_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
color1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => color1_carry_i_2_n_0,
      S(2) => color1_carry_i_3_n_0,
      S(1) => color1_carry_i_4_n_0,
      S(0) => A(0)
    );
\color1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \color1_carry__0_i_2_n_0\,
      S(2) => \color1_carry__0_i_3_n_0\,
      S(1) => \color1_carry__0_i_4_n_0\,
      S(0) => \color1_carry__0_i_5_n_0\
    );
\color1_carry__0_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => color1_carry_i_1_n_0,
      CO(3) => \color1_carry__0_i_1_n_0\,
      CO(2) => \color1_carry__0_i_1_n_1\,
      CO(1) => \color1_carry__0_i_1_n_2\,
      CO(0) => \color1_carry__0_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => g(7 downto 4),
      O(3 downto 0) => A(7 downto 4),
      S(3) => \color1_carry__0_i_6_n_0\,
      S(2) => \color1_carry__0_i_7_n_0\,
      S(1) => \color1_carry__0_i_8_n_0\,
      S(0) => \color1_carry__0_i_9_n_0\
    );
...
\color1_carry__0_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\color1_carry__0_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6965"
    )
        port map (
...
\color1_carry__0_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"95A96695"
    )
        port map (
...
\color1_carry__0_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\color1_carry__0_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\color1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_color1_carry__1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \color1_carry__1_n_2\,
      CO(0) => \color1_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1 downto 0) => A(7 downto 6),
      O(3) => \NLW_color1_carry__1_O_UNCONNECTED\(3),
      O(2 downto 0) => color1(10 downto 8),
      S(3 downto 2) => B"01",
      S(1) => \color1_carry__1_i_1_n_0\,
      S(0) => \color1_carry__1_i_2_n_0\
    );
...
\color1_carry__1_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \color1_carry__0_i_1_n_0\,
      CO(3 downto 1) => \NLW_color1_carry__1_i_3_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \color1_carry__1_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_color1_carry__1_i_3_O_UNCONNECTED\(3 downto 0),
      S(3 downto 0) => B"0001"
    );
color1_carry_i_1: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => color1_carry_i_1_n_0,
      CO(2) => color1_carry_i_1_n_1,
      CO(1) => color1_carry_i_1_n_2,
      CO(0) => color1_carry_i_1_n_3,
      CYINIT => '1',
      DI(3 downto 0) => g(3 downto 0),
      O(3 downto 0) => A(3 downto 0),
      S(3) => color1_carry_i_5_n_0,
      S(2) => color1_carry_i_6_n_0,
      S(1) => color1_carry_i_7_n_0,
      S(0) => color1_carry_i_8_n_0
    );
...
color1_carry_i_4: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
color1_carry_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"96069F9669F96069"
    )
        port map (
      I0 => color2(5),
...
color1_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
color1_carry_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5AA9A95A5A95955A"
    )
        port map (
      I0 => g(0),
      I1 => color2(0),
...
\color[0]_INST_0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => color1(3 downto 0),
      O(3 downto 0) => color(3 downto 0),
      S(3) => \color[0]_INST_0_i_1_n_0\,
      S(2) => \color[0]_INST_0_i_2_n_0\,
      S(1) => \color[0]_INST_0_i_3_n_0\,
      S(0) => \color[0]_INST_0_i_4_n_0\
    );
\color[0]_INST_0_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"69F9606996069F96"
    )
        port map (
      I0 => color2(5),
      I1 => \color[4]_INST_0_i_3_n_0\,
...
\color[0]_INST_0_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A17AA71AA71AA17A"
    )
        port map (
      I0 => color2(3),
      I1 => color2(2),
...
\color[0]_INST_0_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3C38C3838CC3388C"
    )
        port map (
      I0 => color2(1),
      I1 => color2(2),
...
\color[0]_INST_0_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"94292942"
    )
        port map (
...
\color[4]_INST_0_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\color[8]_INST_0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => color1(10),
      S(2 downto 0) => color1(10 downto 8)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
