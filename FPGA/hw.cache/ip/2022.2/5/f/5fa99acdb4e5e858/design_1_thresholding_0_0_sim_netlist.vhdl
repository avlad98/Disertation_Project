...
\color[0]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => color2(0),
      I2 => color2(2),
      I3 => \color[0]_INST_0_i_1_n_0\,
      I4 => color2(3),
      I5 => \color[0]_INST_0_i_2_n_0\,
      O => color(0)
    );
\color[0]_INST_0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2C"
    )
        port map (
...
\color[0]_INST_0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000F0E0FFFF0000"
    )
        port map (
      I0 => color2(4),
      I1 => color2(5),
