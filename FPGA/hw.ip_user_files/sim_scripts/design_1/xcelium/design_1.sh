...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../hw.gen/sources_1/bd/design_1/ipshared/415b/hdl" \
       ...
       +incdir+"$ref_dir/../../../../hw.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/415b/hdl" \
       ...
       +incdir+"../../../../hw.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
