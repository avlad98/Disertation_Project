...
HD_PWD='D:/Facultate/Disertatie/Hybrid_CPU_FPGA_DisertationProject/FPGA/hw.runs/design_1_AXI4_ImageProcessor_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI4_ImageProcessor_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI4_ImageProcessor_0_1.tcl
