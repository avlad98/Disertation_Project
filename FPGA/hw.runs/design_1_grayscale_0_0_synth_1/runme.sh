...
HD_PWD='D:/Facultate/Disertatie/Hybrid_CPU_FPGA_DisertationProject/FPGA/hw.runs/design_1_grayscale_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_grayscale_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_grayscale_0_0.tcl
